...
<head>
  ...
  @if (strpos(Request::url(), 'about_us') !== false)
  <style>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="navbarDropdown">
            <a class="dropdown-item" href="{{url('/tambah_produk')}}">Tambah Produk</a>
            <a class="dropdown-item" href="{{url('/hapusedit_produk')}}">Hapus / Edit Produk</a>
      ...
      <form class="form-inline my-2 my-lg-0" action="{{url("/search")}}" method="get">
        @if ($resulmain != null)
        <a href="{{url("/logout")}}">Logout ({{$resulmain[0]->nama}})</a>
        @else
        
        <a href="{{url("/login")}}" class="btn btn-outline-success my-2 my-sm-0 mr-2" type="submit">Login</a>
        <a href="{{url("/register")}}" class="btn btn-outline-success my-2 my-sm-0" type="submit">Register</a>
        @endif
        @csrf
          ...
          <div class="row">
            ...
            <div class="col-xs-12 col-sm-6 col-md-3">
              <div class="widget subscribe no-box">
                <h5 class="widget-title">Oleh - Oleh Yogya<span></span></h5>
                <p>Oleh - oleh Yogya adalah sebuah website yang memasarkan produk khas Yogyakarta. </p>
              </div>
            </div>

            <div class="col-xs-12 col-sm-6 col-md-3">
              <div class="widget no-box">
                <h5 class="widget-title">Layanan<span></span></h5>
                <ul class="thumbnail-widget">
                  <li>
                    <div class="thumb-content"><a href="#.">Cara Belanja</a></div>
                  </li>
                  <li>
                    <div class="thumb-content"><a href="#.">Cara Menjadi Vendor</a></div>
                  </li>
                  <li>
                    <div class="thumb-content"><a href="#.">Tentang Kami</a></div>
                  </li>
                  <li>
            ...
            <div class="col-xs-12 col-sm-6 col-md-3">
              <div class="widget no-box">
                <h5 class="widget-title">Mulai Belanja<span></span></h5>
                <p>Bergabung bersama kami dan dapatkan produk sesuai keinginan Anda.</p>
